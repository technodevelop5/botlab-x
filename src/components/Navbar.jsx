...
const Navbar = () => {
  ...
  // 2. Added 'path' properties to match your App.jsx routes
  const navItems = [
    { name: 'Dashboard', path: '/dashboard', icon: <Layout className="w-4 h-4" />, badge: null },
    { name: 'Experiments', path: '/experiments', icon: <Target className="w-4 h-4" />, badge: 'New' }, // <--- Points to ExperimentList
    { name: 'Chatbot Editor', path: '/chatboteditor', icon: <MessageSquare className="w-4 h-4" />, badge: null },
    { name: 'Results', path: '/results', icon: <BarChart3 className="w-4 h-4" />, badge: null },
    { name: 'Settings', path: '/settings', icon: <Settings className="w-4 h-4" />, badge: null }
  ];
