...
import { MessageSquare, Mail, Lock, Eye, EyeOff, ArrowRight, CheckCircle, User, Briefcase } from 'lucide-react';
        ...
        <div className="auth-branding">
          ...
          <div className="auth-branding-content">
            ...
            <p className="auth-branding-text">
              Join 25,000+ researchers transforming how they conduct UX studies. Build chatbots, deploy surveys, and analyze results—all in one platform.
            </p>
            ...
            <div className="auth-features">
              ...
              <div className="auth-feature">
                <CheckCircle className="w-5 h-5 text-green-500" />
                <span>Unlimited experiments & participants</span>
              </div>
              <div className="auth-feature">
                <CheckCircle className="w-5 h-5 text-green-500" />
          ...
          <div className="auth-stats">
            <div className="auth-stat">
              <div className="auth-stat-value">25k+</div>
              <div className="auth-stat-label">Active Users</div>
            </div>
            <div className="auth-stat">
              <div className="auth-stat-value">1.2M+</div>
              <div className="auth-stat-label">Conversations</div>
            </div>
            <div className="auth-stat">
              <div className="auth-stat-value">4.9/5</div>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="form-checkbox-group">
                ...
                <label htmlFor="agreeToTerms" className="form-checkbox-label">
                  I agree to the <Link to="/terms" className="form-inline-link">Terms of Service</Link> and <Link to="/privacy" className="form-inline-link">Privacy Policy</Link>
                </label>
              </div>
